...
This contributing guide is heavily based on the contributing guide from
[rcompendium](https://github.com/FRBCesab/rcompendium/) and
...
Conduct](https://github.com/adrientaudiere/comparpq/blob/main/CODE_OF_CONDUCT.md).
...
`comparpq` uses the `lower_snake_case` except when we want to integrate
names from other packages.

## Commit messages

If you want to contribute by commiting changes, please try to use (at
least more than me) the [Conventional
commits](https://www.conventionalcommits.org/en/v1.0.0/) specification.

## Asking questions

Before you ask a question, it is best to search for existing
[Issues](https://github.com/adrientaudiere/comparpq/issues) that might
...
- Open a new
  [Issue](https://github.com/adrientaudiere/comparpq/issues/new).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/adrientaudiere/comparpq/issues?q=label%3Abug).

### How do I submit a bug report?

We use [GitHub
Issues](https://github.com/adrientaudiere/comparpq/issues) to track bugs
...
- Make sure that you are using the latest version of `comparpq`.
- Read the [documentation](https://github.com/adrientaudiere/comparpq/)
  carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/adrientaudiere/comparpq/issues)
...
Issues](https://github.com/adrientaudiere/comparpq/issues).
...
7.  Submit a [Pull
    ...
    on the [original
    repo](https://github.com/adrientaudiere/comparpq/compare).
...
corresponding `Rmd` file stored in the `vignettes/` folder. If you want
to contribute by adding a new vignette, create a new `Rmd` file in the
