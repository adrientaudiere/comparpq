...
- When documenting parameters, always start with the type of the
  parameter (e.g. “Integer”, “Logical”, “A data frame”, and add required
  information as needed). For example:
