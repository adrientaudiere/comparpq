...
Single-context workspace: one shared `CONTEXT.md` + `docs/adr/` at the **pqverse workspace root** (`../../CONTEXT.md`, `../../docs/adr/`), not per-package. comparpq's `CONTEXT.md` is a symlink to the workspace root. ADR-0001 records the views-axis identity. See `docs/agents/domain.md`.
