...
- Always follow the Conventional Commits specification (https://www.conventionalcommits.org/en/v1.0.0/)
...
- When documenting parameters, always start with the type of the parameter (e.g. "Integer", "Logical", "A data frame", and add required information as needed). For example: 
  - `@param x (Int, required) An integer vector of length 1`
  - `@param y (Logical, default NULL) A boolean factor.
