# Contributing to comparpq

First off, thanks for taking the time to contribute to `comparpq`! 

This contributing guide is heavily based on the contributing guide from [rcompendium](https://github.com/FRBCesab/rcompendium/) and [MiscMetabar](https://github.com/adrientaudiere/MiscMetabar).
...
[Contributor Code of Conduct](https://github.com/adrientaudiere/comparpq/blob/main/CODE_OF_CONDUCT.md).
...
`comparpq` uses the `lower_snake_case` except when we want to integrate names from other packages. 
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/adrientaudiere/comparpq/issues) that might help you. In case you have found a suitable issue and still need clarification, you 
can write your question in this issue.

If you then still feel the need to ask a question and need clarification, we 
recommend the following:

- Open a new [Issue](https://github.com/adrientaudiere/comparpq/issues/new).
...
- Make sure that you are using the latest version of `comparpq`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/adrientaudiere/comparpq/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/adrientaudiere/comparpq/issues) to 
...
- Make sure that you are using the latest version of `comparpq`.
- Read the [documentation](https://github.com/adrientaudiere/comparpq/) carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/adrientaudiere/comparpq/issues) to see if this enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.

### How do I submit a feature request?

Feature requests are tracked as [GitHub Issues](https://github.com/adrientaudiere/comparpq/issues).

- Open a new [Issue](https://github.com/adrientaudiere/comparpq/issues/new).
- Provide a clear and descriptive title for the issue to identify the suggestion.
- Provide a step-by-step description of the suggested enhancement in as 
many details as possible.
- Explain why this enhancement would be useful to most `comparpq` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/adrientaudiere/comparpq/compare).
